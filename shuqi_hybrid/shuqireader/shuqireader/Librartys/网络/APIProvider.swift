...
enum API {
    case homeGoodsList(linkStr: String) //
...
extension API: TargetType {
    ...
    public var baseURL: URL {
         return URL(string: "https://chapter2.zhuishushenqi.com/chapter/")!
    }

    var path: String {
        switch self {
            case .homeGoodsList(let linkStr): return  LTtool.stringURLEncode(linkStr)
