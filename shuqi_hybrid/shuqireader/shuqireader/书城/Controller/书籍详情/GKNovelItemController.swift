...
class GKNovelItemController: LTSuperViewController {
    ...
    private lazy var titleLab: UILabel = {
        ...
        label.textColor = LTtool.color(withHexString:"999999");
        label.font = UIFont.systemFont(ofSize:12);
        return label
    }()
    private lazy var subTitleLab: UILabel = {
        var subTitleLab :UILabel = UILabel.init();
        subTitleLab.textColor = LTtool.color(withHexString: "999999");
