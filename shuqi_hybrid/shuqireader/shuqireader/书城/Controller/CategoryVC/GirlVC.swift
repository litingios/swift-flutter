...
class GirlVC: LTSuperViewController {
...
//        self.collectionView.contentInset = UIEdgeInsets(top: 0, left: 15, bottom: 0, right: 15)
    ...
    /// 获取轮播图数据
    func loadData() -> Void {
        let path = Bundle.main.path(forResource: "home_girl", ofType: "json")
...
extension GirlVC: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
