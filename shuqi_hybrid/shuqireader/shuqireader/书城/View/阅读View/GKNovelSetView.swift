...
class GKNovelSetView: UIView,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,UICollectionViewDelegate {
    ...
    override func awakeFromNib() {
        ...
        self.colletionView.snp.makeConstraints { (make) in
            ...
            make.top.equalTo(self.leftBtn.snp.bottom).offset(15)
        ...
        self.reduceBtn.layer.borderColor = LTtool.color(withHexString: "999999").cgColor;
        
        self.addBtn.layer.masksToBounds = true;
        self.addBtn.layer.cornerRadius = 5;
        self.addBtn.layer.borderWidth = 1.0
        self.addBtn.layer.borderColor = LTtool.color(withHexString: "999999").cgColor;
    ...
    func changeButtonState(){
        ...
        for obj in self.buttonDatas {
            ...
            if model.browse.rawValue == index{
                ...
                button.setTitleColor(LTtool.color(withHexString: "333333"), for: .normal);
                button.backgroundColor = LTtool.color(withHexString: "eeeeee");
            }
            index  = index + 1;
        }
    }
