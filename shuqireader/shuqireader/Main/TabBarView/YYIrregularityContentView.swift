...
class YYIrregularityBasicContentView: YYBouncesContentView {
    ...
    override init(frame: CGRect) {
        ...
        //tar 未选中字体颜色
        textColor = UIColor.init(red: 103/255.0, green: 103/255.0, blue: 105/255.0, alpha: 1.0)
        //tar 选中字体颜色
        highlightTextColor = UIColor.init(red: 68/255.0, green: 191/255.0, blue: 155/255.0, alpha: 1.0)
        //tar 未选中图片颜色
        iconColor = UIColor.init(red: 159/255.0, green: 159/255.0, blue: 163/255.0, alpha: 1.0)
        //tar 选中图片颜色
        highlightIconColor = MainColor
