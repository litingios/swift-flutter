...
class OptimizationVC: LTSuperViewController {
    ...
    override func viewDidLoad() {
        ...
        self.collectionView.register(UINib.init(nibName: "HotSaleCellCollectionViewCell", bundle: nil), forCellWithReuseIdentifier: "HotSaleCellCollectionViewCell")
    ...
    /// 获取轮播图数据
    func loadData() -> Void {
        let path = Bundle.main.path(forResource: "home_optimization", ofType: "json")
...
extension OptimizationVC: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if indexPath.section == 0 || indexPath.section == 2 || indexPath.section == 3 {
            ...
            cell.listenHidden = true
            return cell
            
        }else if indexPath.section == 1 {
            let cell:VerticalBookCell! = collectionView.dequeueReusableCell(withReuseIdentifier: "VerticalBookCell", for: indexPath) as? VerticalBookCell
            cell.model = self.booksList![indexPath.section+1].content![indexPath.row]
            cell.listenHidden = false
            return cell
            
        }else if indexPath.section == 4 {
            let cell:HotSaleCellCollectionViewCell! = collectionView.dequeueReusableCell(withReuseIdentifier: "HotSaleCellCollectionViewCell", for: indexPath) as? HotSaleCellCollectionViewCell
            cell.boyList = self.booksList![indexPath.section+1].boyContent
            cell.girlList = self.booksList![indexPath.section+1].girlContent
            return cell
        }else{
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        if indexPath.section == 0 {
            ...
            return CGSize(width: (self.view.frame.size.width-50)/3, height: VerticalHeight);
            ...
            return CGSize(width: AcrossWidth, height: 530);
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, referenceSizeForHeaderInSection section: Int) -> CGSize {
        if section == 0 {
            return CGSize(width: ScreenWidth, height: 290)
        }else{
